       ...
       private var ListPersonAdaptor=ArrayList<Note>()
        ...
        override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
           val myView= layoutInflater.inflate(R.layout.ticket,null)
            ...
            myView.button2.setOnClickListener(object : View.OnClickListener {
                override fun onClick(v: View?) {
                    //Toast.makeText(applicationContext,myNode.phnNumber,Toast.LENGTH_SHORT).show()
                    val callIntent = Intent(Intent.ACTION_DIAL)
                    callIntent.data = Uri.parse("tel:" + myNode.phnNumber)
